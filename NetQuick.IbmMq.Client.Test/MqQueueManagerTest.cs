...
namespace NetQuick.IbmMq.Client.Test
{
    public class MqQueueManagerTest
    {
        ...
        public void Test()
        {
            var queueManager = new MqQueueManager("QM1", properties => properties
                .WithChannel("DEV.APP.INS.CONN")
            ...
            message.WithMessageFlags(flags => flags
                                                .AllowSegmentation()
            ...
            var value = resultMessage.ReadString(11);
